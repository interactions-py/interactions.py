...
class Embed(DictSerializerMixin):
    ...
    def insert_field_at(self, index: int,  name: str, value: str, inline: Optional[bool] = False): ...
    ...
    def set_thumbnail(self, url: str, proxy_url: Optional[str] = None, height: Optional[int] = None, width: Optional[int] = None): ...
