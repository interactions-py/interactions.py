...
class _SendDMMixin(SendMixin):
    id: Snowflake_Type
    async def _send_http_request(self, message_payload: Union[dict, 'FormData'], files: Union[list['UPLOADABLE_TYPE'], None] = ...) -> dict: ...
...
class Member(FakeUserMixin):
    ...
    async def timeout(self, communication_disabled_until: Union['Timestamp', datetime, int, float, str, None], reason: Absent[str] = ...) -> dict: ...
    async def move(self, channel_id: Snowflake_Type) -> None: ...
    async def edit(self, *, nickname: Absent[str] = ..., roles: Absent[Iterable['Snowflake_Type']] = ..., mute: Absent[bool] = ..., deaf: Absent[bool] = ..., channel_id: Absent['Snowflake_Type'] = ..., communication_disabled_until: Absent[Union['Timestamp', None]] = ..., reason: Absent[str] = ...) -> None: ...
    async def kick(self, reason: Absent[str] = ...) -> None: ...
    async def ban(self, delete_message_days: Absent[int] = ..., delete_message_seconds: int = ..., reason: Absent[str] = ...) -> None: ...
