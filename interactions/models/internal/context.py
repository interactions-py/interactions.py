...
class PrefixedContext(BaseContext[ClientT], SendMixin):
    ...
    command: "interactions.PrefixedCommand"
    "The command this context invokes."
...
class HybridContext(BaseContext[ClientT], SendMixin):
    ...
    _prefixed_ctx: PrefixedContext[ClientT] | None
    ...
    @classmethod
    def from_prefixed_context(cls, ctx: PrefixedContext[ClientT]) -> Self:
    ...
    @property
    def inner_context(self) -> SlashContext[ClientT] | PrefixedContext[ClientT]:
        """The inner context that this hybrid context is wrapping."""
        return self._slash_ctx or self._prefixed_ctx  # type: ignore

    @property
    def command(self) -> "interactions.HybridSlashCommand":
