...
from interactions.models.internal.converters import _LiteralConverter, NoArgumentConverter, Greedy, NAFF_MODEL_TO_CONVERTER
...
class PrefixedCommand(BaseCommand):
    ...
    def _parse_parameters(self) -> None:
        """
        Parses the parameters that this command has into a form interactions can use.
    ...
    async def call_callback(self, callback: Callable, ctx: "PrefixedContext") -> None:
        ...
        Args:
            callback (Callable: The callback to run. This is provided for compatibility with interactions.
            ctx (interactions.MessageContext): The context to use for this command.
        """
