...
class Client:
    ...
    def remove(self, name: str, package: Optional[str] = None, remove_commands: Optional[bool] = True) -> None: ...
    def reload(
...
class Extension:
    ...
    async def teardown(self, remove_commands: Optional[bool] = True) -> None: ...
