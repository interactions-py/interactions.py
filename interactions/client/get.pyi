...
# single objects
@overload
def get(client: Client, obj: Type[Channel], *, channel_id: int) -> Awaitable[Channel]: ...
@overload
def get(client: Client, obj: Type[Emoji], *, guild_id: int, emoji_id: int) -> Awaitable[Emoji]: ...
@overload
def get(client: Client, obj: Type[Guild], *, guild_id: int) -> Awaitable[Guild]: ...
@overload
def get(client: Client, obj: Type[Member], *, guild_id: int, member_id: int) -> Awaitable[Member]: ...
@overload
def get(
    client: Client,
    obj: Type[Message],
